...
// Acá se descarga el Ranking de comunas
              document.getElementById('downloadRanking').addEventListener('click', function() {
                ...
                /********************************************************************************/
                //downloadLink.download = "Ranking.svg"; // CAMBIAR NOMBRE PARA DESCARGAR
                downloadLink.download = "Ranking ICVU 2019.png";
                /********************************************************************************/
                document.body.appendChild(downloadLink);
                downloadLink.click();
                document.body.removeChild(downloadLink);
  ...
  function drawDashboard() {
    ...
    ///$.get("datos_icvu2.csv", function(csvString) { // INICIO get
      $.get("datos_icvu2019.csv", function(csvString) { // INICIO get
        ...
        var MetropolitanaFilter = new google.visualization.ControlWrapper({
          ...
          'options': {
            ...
            ui: {
                ...
                caption : 'Área Metropolitana e Intermedias'
            },values: ["ÁREA METROPOLITANA", "INTERMEDIA"]
...
/* ESTO ES LO PENDIENTE A SUBIR  -> **/
        ...
        var DistribucionFilter = new google.visualization.ControlWrapper({
          ...
          'options': {
            ...
            values: ["NORTE", "CENTRO", "SUR", "SUR-AUSTRAL"],
        // use month name
...
/// Dashboard <=
      ...
      function Base(){
        ...
        if(order1 > 7){
          theTitle = 'Ranking ICVU 2019 para ' + theTitle;
        }else{
          theTitle = "Ranking ICVU 2019 General";
        }
      }
